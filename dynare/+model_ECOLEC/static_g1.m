...
if T_flag
    T = model_ECOLEC.static_g1_tt(T, y, x, params);
end
g1 = zeros(46, 46);
g1(1,3)=1;
...
g1(26,13)=1;
g1(26,21)=(-1);
g1(27,19)=(-(y(30)*y(27)*params(59)*(params(38)-y(27))));
g1(27,27)=1-y(30)*(1+y(19)*params(59)*(params(38)-y(27))+y(27)*(-(y(19)*params(59))));
g1(27,30)=(-(y(27)*(1+y(19)*params(59)*(params(38)-y(27)))));
